<div class="remittanceBatch index large-12 medium-10 columns content">
    <h3><?= __('Moving Sum Transaction Amount Limit Filter Setup') ?></h3>
    <div class="users form">
        ...
        <ul class="fieldlist">
            ...
            <li>
                ...
                <?=  $this->Form->select('matching', ['name'=>'Name', 'id_number'=>'ID card No.', 'account'=>'Account No.', 'bank_code'=>'Bank Name'],
...
$(document).ready(function() {
    ...
    $("#grid").kendoGrid({
        columns: [
            ...
            {field: "amount_limit_type",title: "Type", width: 60},
            {field: "amount_limit",title: "Amount", width: 120, format: "{0:n2}", attributes:{class:"numeric"}},
