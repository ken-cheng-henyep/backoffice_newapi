...
<tr><td><?php echo $symbol['rate_symbol']?></td><td><input type="number" required="" name="symbol_rates[<?php echo $symbol['id']?>]" value="<?php echo $symbol['rate_value']?>" step="0.0001" min="0" /></td><td><?php echo $symbol['description']?></td></tr>
<?php endforeach;?>
</tbody>
</table>
